...
import { OrdenReparacionCelService } from '../Services/ordenReparacionCel/orden-reparacion-cel.service';

@Component({
  selector: 'app-orden-reparacion-cel',
  templateUrl: './orden-reparacion-cel.page.html',
  styleUrls: ['./orden-reparacion-cel.page.scss'],
})
export class OrdenReparacionCelPage implements OnInit {
